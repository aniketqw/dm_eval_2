...
#     "NUM_SAMPLES": 500,                     # Monte‑Carlo draws per series
...
#     logger.info("=== Chronos Evaluation – generic wrapper ===")
...
#         pred_len       = CONFIG["PREDICTION_LENGTH"],   # <-- now passed explicitly
#         logger         = logger,
#     )
...
def main():
    logger = setup_logging()
    logger.info("=== Chronos Evaluation – generic wrapper (WITH BASELINE NORMALIZATION) ===")
    logger.info(f"Configuration: {CONFIG}")
